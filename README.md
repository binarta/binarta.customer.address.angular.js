# binarta.customer.address.angular.js

[AngularJS](http://angularjs.org/) module for customer address functionality based on the [Binarta](http://binarta.com/) platform.
